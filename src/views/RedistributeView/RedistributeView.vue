    ...
    <section>
        ...
        <main class="view">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<h2>Redistribuir processos</h2>
                        <div class="sub">processos que retornaram ao SISCONT</div>
					</div>
				</div>
                ...
                <div class="row separator">
                    ...
                    <div class="col-6">
                        <div class="input_content">
                            <input type="text" placeholder="Pesquise pelo numero do processo" class="input-text" />
                            <button>
